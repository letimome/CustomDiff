...
// PV:IFCOND(pv:hasFeature('Temperature'))
 ...
 setScale(parent, minTemp, maxTemp, tempScale, 20);//Authored by: letimome in commit:daf2fe5d8a9b7884dccd4bf9c871a34d9e049f87, with message:resolved #11 #12 and a fix on main title 
// PV:ENDCOND
