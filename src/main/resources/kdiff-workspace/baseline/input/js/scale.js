...
// PV:IFCOND(pv:hasFeature('WindSpeed'))
	...
	var cell = svg
    .selectAll(".node")
    setElementText(document.getElementById('temp_title'), tempTitle);//Authored by: letimome in commit:4b16f1cbd2bcee77c7bd5c7c508307d1877a5b54, with message:added scale 
 var label = cell.append("text")//Authored by: letimome in commit:4b16f1cbd2bcee77c7bd5c7c508307d1877a5b54, with message:added scale 
    .attr("clip-path", function(d) { return "url(#clip-" + d.id + ")"; });//Authored by: letimome in commit:4b16f1cbd2bcee77c7bd5c7c508307d1877a5b54, with message:added scale 
