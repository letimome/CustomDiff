...
@Controller
public class Diff_Feature_CoreAsset_ProductAsset_Controller {
	 ...
	 @RequestMapping("simple_diff_ca_pa_filter")
	   public String getDiffFeatureCaPaFilter(
	   ...
	   return "alluvials/simple_diff_ca_pa_filter";
	 }
