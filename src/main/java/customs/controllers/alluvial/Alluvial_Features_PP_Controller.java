	...
	@RequestMapping("diff_features_pp")
	   public String getMainAlluvialView ( 	   		
		...
		//   if(filter==null) csvCustoms = csvCustoms.concat(extractCSVForNotCustomizedProducts(customizedproductreleases));
		  ...
		  model.addAttribute("maintitle","Which "+pf.getName()+" \"child features\" have been customized by the product portfolio?");
		  ...
		  customs.utils.NavigationMapGenerator.generateNavigationMapForFeatureSideLevel1(pf.getName() + " children", "core-asset", "Filter", "Variant","Component");
